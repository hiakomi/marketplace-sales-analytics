...
|---|---|---|
| Продажи — основные метрики | Общая сводка, ассортимент, активность и ценность клиентов | [Открыть Metabase](http://194.58.118.193:3000/public/dashboard/978dff62-493d-4fd6-bb8e-1ac864d4224c) |
| Анализ клиентской базы и ассортимента | RFM, retention, LTV, сценарии и ABC/XYZ | [Открыть Metabase](http://194.58.118.193:3000/public/dashboard/955746b0-6571-4fc7-b266-d2311d82217a) |
...
Дашборды размещены в Metabase на VPS и доступны по публичным ссылкам `/public/dashboard/` без входа в аккаунт. Их доступность и скорость загрузки зависят от работы сервера и приложения. Учётные данные для просмотра не требуются.

Репозиторий публичный. Скриншоты сохранены в GitHub и доступны без авторизации, в том числе при недоступном сервере Metabase.
